...
- **Objective**: Conversion-rate experiment design, synthetic data simulation, hypothesis testing (z-proportion), confidence intervals, and sequential monitoring guidance to support reliable experiment decisions. See [Project_2_ABtesting.ipynb](Project_2_ABtesting.ipynb).
## **Project 3 - Portfolio Risk Assessment (Value at Risk)** 
- **Objective**: Financial time series preprocessing, return modeling, parametric and historical VaR estimation, and backtesting to validate risk measures. See [Project_3_PRA_vaR.ipynb](Project_3_PRA_vaR.ipynb).
...
## **How to View**
- Open the notebooks in Jupyter or JupyterLab. To install dependencies, run:

```
pip install -r requirements.txt
```

If no requirements file is present, install the core libraries: pandas, numpy, matplotlib, seaborn, scipy, statsmodels.

## **Usage Notes**
- The EDA notebook is structured to be self-contained: it includes data loading, cleaning steps, analysis cells, and visualizations suitable for sharing with hiring managers or embedding results into a portfolio.
- Replace the placeholder GitHub link below with your profile URL when adding this repository to your resume.
